 ...
 *
 * @param  array $options Array of page IDs
 * @return array $options Page IDs after forcing all values to positive integers
 * @since  0.1.0
 */
function slimline_archives_sanitize_array( $options = array() ) {

	/**
	 * Force all values into positive integers
	 *
...
/**
 *
 * @param  string $key                    Identifier for the SEO value to retrieve
 * @param  string $value                  SEO value
 * @param  string WP_Post_Type|$post_type Post type to retrieve the value for. Default
 *                                        to current post type if viewing a post archive
 * @return string $value                  Page meta for the page assigned as the archive
...
function slimline_archives_wpseo_meta( $key, $value = '', $post_type = null ) {
	...
	/**
	 * Make sure a function exists for retrieving the given meta value
	 *
	 * @link http://php.net/manual/en/function.function-exists.php
	 *       Documentation of the PHP `function_exists` function
	 */
...
/**
 * Helper function for replacing the Yoast meta description for a post archive with
 * the custom description created in the assigned page.
 *
 * @param  string $metadesc Default Yoast meta description
...
/**
 * Helper function for replacing the Yoast meta keywords for a post archive with
 * the custom keywords created in the assigned page.
 *
 * @param  string $keywords Default Yoast meta keywords
...
/**
 * Helper function for replacing the Yoast meta title for a post archive with
 * the custom title created in the assigned page.
 *
 * @param  string $title Default Yoast meta title
 * @return string $title
 * @since  0.1.0
 */
